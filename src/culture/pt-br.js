(function (translator) {
	translator.translations["pt-br"] = {
		...
		"paperlabelbitcoinaddress": "Endereço EXOS:",
		...
		"brainalertpassphrasewarning": "Aviso: É importante que você escolha uma senha forte, para evitar ataques de força bruta que tentem adivinhar sua senha e roubar seus EXOSs.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada inválida. Não é possível multiplicar duas chaves públicas. Clique em 'Somar' e some duas chaves públicas para adquirir um endereço EXOS.",
		...
		"tagline": "Gerador local de carteiras EXOS usando Javascript de código aberto",
		"generatelabelbitcoinaddress": "Gerando endereço EXOS...",
		...
		"singlelabelbitcoinaddress": "Endereço EXOS",
		"singlelabelprivatekey": "Chave privada (Wallet Import Format):",
		"singletip1": "<b>Uma carteira EXOS</b> nada mais é do que um endereço EXOS e a sua chave privada EXOS correspondente. Essa carteira foi gerada para você em seu navegador web e está sendo exibida acima.",
		"singletip2": "<b>Para proteger essa carteira</b> você deve imprimir ou anotar/salvar o endereço EXOS e a sua chave privada correspondente. É importante que você faça uma cópia de segurança da sua chave privada e armazene-a em um local seguro. Esse site não toma conhecimento da sua chave privada. Se você for familiar com criptografia PGP, você pode baixar essa página HTML em um arquivo único e verificar se você tem uma versão autêntica do autor deste site ao fazer a correspondência do hash SHA256 deste HTML com o hash SHA256 disponível na versão assinada do arquivo contido no link no rodapé deste site. Se você sair/atualizar essa página ou apertar o botão Gerar Novo Endereço, então uma nova chave privada será gerada e a chave exibida anteriormente não será recuperável.	A sua chave privada EXOS deve ser mantida em um segredo. Qualquer pessoa que tiver acesso a ela poderá gastar todos os seus EXOSs associados com aquele endereço. Se você imprimir sua carteira, armazene-a em um saco plástico selado para mantê-la longe da água. Trate sua carteira em papel como se fosse dinheiro.",
		"singletip3": "<b>Adicione fundos</b> para essa carteira ao indicar para outras pessoas enviarem EXOSs para o seu endereço EXOS.",
		"singletip4": "<b>Verifique seu saldo</b> visitando os sites blockchain.info ou blockexplorer.com e digitando o seu endereço EXOS.",
		"singletip5": "<b>Gaste seus EXOSs</b> visitando o site blockchain.info e esvaziando completamente o seu saldo de sua chave privada para sua conta no site. Você também pode gastar seus fundos ao baixar um cliente EXOS p2p popular e importar sua chave privada para a carteira do aplicativo. Tenha em mente que quando você importa uma chave única para um cliente EXOS p2p e gasta seus fundos, sua chave será agrupada com outras chavfes privadas no aplicativo de carteira. Quando você realizar uma transação o seu troco será enviado para outro endereço EXOS dentro do seu aplicativo de carteira. Você deve então fazer backup da sua carteira em seu aplicativo e mantê-la em segurança, visto que seus EXOSs remanescentes agora serão armazenados nela. Um conselho do Satoshi Nakamoto é de que uma carteira nunca deve ser apagada.",
		...
		"brainlabelbitcoinaddress": "Enderçeo EXOS:",
		...
		"vanitylabelbitcoinaddress": "Endereço EXOS Vanity:",
		...
		"detaillabelnote2": "As versões do EXOS acima da v0.6+ armazenam as chaves públicas comprimidas. O cliente também suporta a importação/exportação de chaves privadas usando importprivkey/dumpprivkey. O formato das chaves privadas exportadas depende se o endereço foi gerado em uma carteira antiga ou nova.",
		"detaillabelbitcoinaddress": "Endereço EXOS:",
		"detaillabelbitcoinaddresscomp": "Endereço EXOS (comprimido):",
