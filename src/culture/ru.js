(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelbitcoinaddress": "Адрес Rutanio кошелька:",
		...
		"detaillabelnote2": "Приложение Rutanio версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
