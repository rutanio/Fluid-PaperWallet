(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelbitcoinaddress": "Dirección Fluid:",
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus Fluids.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección Fluid.",
		...
		"tagline": "Generador de carteras Fluid de código abierto en lado de cliente con Javascript",
		"generatelabelbitcoinaddress": "Generando dirección Fluid...",
		...
		"singlelabelbitcoinaddress": "Dirección Fluid",
		...
		"brainlabelbitcoinaddress": "Dirección Fluid:",
		...
		"vanitylabelbitcoinaddress": "Dirección Fluid personalizada:",
		...
		"detaillabelnote2": "Fluid v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelbitcoinaddress": "Dirección Fluid:",
		"detaillabelbitcoinaddresscomp": "Dirección Fluid (comprimida):",
