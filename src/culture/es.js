(function (translator) {
	translator.translations["es"] = {
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus EXOS.",
		...
		"bulklabelq1": "¿Por qué debo usar \"Direcciones en masa\" para aceptar EXOS en mi web?",
		"bulka1": "La forma tradicional de aceptar EXOS en tu web requiere tener instalado el cliente oficial de EXOS (\"EXOSd\"). Sin embargo muchos servicios de hosting no permiten instalar dicho cliente. Además, ejecutar el cliente en tu servidor supone que las claves privadas están también en el servidor y podrían ser comprometidas en caso de intrusión. Al usar este mecanismo, puedes subir al servidor sólo las dirección de EXOS y no las claves privadas. De esta forma no te tienes que preocupar de que alguien robe la cartera si se cuelan en el servidor.",
		"bulklabelq2": "¿Cómo uso \"Direcciones en masa\" para aceptar EXOS en mi web?",
		...
		"bulklabela2li5": "Las EXOS que recibas se almacenarán de forma segura en la cadena de bloques. Usa la cartera original que generaste en el paso 1 para usarlas.",
